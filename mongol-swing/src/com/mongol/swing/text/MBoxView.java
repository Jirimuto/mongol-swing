...
public class MBoxView extends MCompositeView{
     ...
     */
    public MBoxView(Element elem, int axis) {
        super(elem);
...
//        System.out.println("axis="+axis+",span="+span+", majorSpan="+majorSpan+", minorSpan="+minorSpan);
    ...
    public void paint(Graphics g, Shape allocation) {
        ...
        Shape shape = adjustedClip(clip, allocation);
        clip = (shape instanceof Rectangle)?(Rectangle)shape : shape.getBounds();
