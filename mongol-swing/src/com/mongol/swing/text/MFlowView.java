 ...
 * @author  jrmt@Almas
 */
public abstract class MFlowView extends MBoxView {
     ...
     */
    public MFlowView(Element elem, int axis) {
    	super(elem, axis);
    ...
    public static class FlowStrategy {
        ...
        void addDamage(MFlowView fv, int offset) {
	 ...
	 * @see View#insertUpdate
	 */
    public void insertUpdate(MFlowView fv, DocumentEvent e, Rectangle alloc) {
	 ...
	 * @see View#removeUpdate
	 */
    public void removeUpdate(MFlowView fv, DocumentEvent e, Rectangle alloc) {
        addDamage(fv, e.getOffset());
	    if (alloc != null) {
			Component host = fv.getContainer();
			if (host != null) {
	 ...
	 * @see View#changedUpdate
	 */
    public void changedUpdate(MFlowView fv, DocumentEvent e, Rectangle alloc) {
        addDamage(fv, e.getOffset());
	    if (alloc != null) {
			Component host = fv.getContainer();
			if (host != null) {
	 ...
	 */
	protected View getLogicalView(MFlowView fv) {
	 ...
	 */
	public void layout(MFlowView fv) {
	 ...
	 */
	protected int layoutRow(MFlowView fv, int rowIndex, int pos) {
		if( fv.getRotateDirection() == MSwingRotateUtilities.ROTATE_HORIZANTAL )
			return layoutRowHorizantal(fv, rowIndex, pos);
		else 
			return layoutRowVertical(fv, rowIndex, pos);
	}
	protected int layoutRowHorizantal(MFlowView fv, int rowIndex, int pos) {
	...
	protected int layoutRowVertical(MFlowView fv, int rowIndex, int pos) {
        View row = fv.getView(rowIndex);
        float x = fv.getFlowStart(rowIndex);
        float spanLeft = fv.getFlowSpan(rowIndex);
        int end = fv.getEndOffset();
	 ...
	 */
    protected void adjustRow(MFlowView fv, int rowIndex, int desiredSpan, int x) {
	    final int flowAxis = fv.getFlowAxis();
	 ...
	 */
	protected View createView(MFlowView fv, int startOffset, int spanLeft, int rowIndex) {
     ...
     */
    static class LogicalView extends MCompositeView {

	LogicalView(Element elem) {
	    super(elem);
	    super.setRotateDirection(getRotateDirection());
	    super.setRotateHint(getRotateHint());
	}
