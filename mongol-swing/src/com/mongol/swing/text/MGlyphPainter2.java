 ...
 * @see GlyphView
 */
public class MGlyphPainter2 extends MGlyphView.GlyphPainter {

    public MGlyphPainter2(TextLayout layout) {
        this.layout = layout;
    }
     ...
     */
    public MGlyphView.GlyphPainter getPainter(MGlyphView v, int p0, int p1) {
        return null;
    }
    ...
    /**
         ...
         */
        public int getNextVisualPositionFrom(MGlyphView v, int pos,
            ...
            Segment text;
            boolean viewIsLeftToRight = true;
