 ...
 * @author jrmt@Almas
 */
public class MBlockView extends MBoxView {
	 ...
	 */
	public MBlockView(Element elem, int axis) {
		super(elem, axis);
	}
	 ...
	 * axis orthoginal to the axis along with it tiles). This is implemented to
	...
	protected SizeRequirements calculateMinorAxisRequirements(int axis,
		 ...
		 */
		if (axis == X_AXIS) {
			Object o = getAttributes().getAttribute(MCSS.Attribute.TEXT_ALIGN);
			if (o != null) {
	...
	static boolean spanSetFromAttributes(int axis, SizeRequirements r,
			MCSS.LengthValue cssWidth, MCSS.LengthValue cssHeight) {
		if (axis == X_AXIS) {
	...
	/**
	 * Performs layout for the minor axis of the box (i.e. the axis orthoginal
	...
	protected void layoutMinorAxis(int targetSpan, int axis, int[] offsets,
			int[] spans) {
		int n = getViewCount();
		Object key = (axis == X_AXIS) ? MCSS.Attribute.WIDTH
				: MCSS.Attribute.HEIGHT;
		for (int i = 0; i < n; i++) {
			View v = getView(i);
	...
	public float getAlignment(int axis) {
		...
		case View.Y_AXIS:
			...
			float a = (((int) span) != 0) ? (above * v
					.getAlignment(View.Y_AXIS)) / span : 0;
			return a;
		default:
			throw new IllegalArgumentException("Invalid axis: " + axis);
		}
	...
	protected void setPropertiesFromAttributes() {
		...
		cssHeight = (MCSS.LengthValue) attr.getAttribute(MCSS.Attribute.HEIGHT);
	}
