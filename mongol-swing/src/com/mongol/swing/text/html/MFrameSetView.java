...
/**
 * Modified FrameSetView
 * 
 * @author jrmt@Almas
 */

public class MFrameSetView extends javax.swing.text.BoxView {
	...
	private void init() {
		if (getAxis() == View.Y_AXIS) {
			children = parseRowColSpec(MHTML.Attribute.ROWS);
		} else {
			children = parseRowColSpec(MHTML.Attribute.COLS);
		}
