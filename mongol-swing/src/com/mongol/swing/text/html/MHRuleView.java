...
class MHRuleView extends View {
	...
	protected void setPropertiesFromAttributes() {
		MStyleSheet sheet = ((MHTMLDocument) getDocument()).getStyleSheet();
		...
		if (attr != null) {
			...
			noshade = (String) eAttr.getAttribute(MHTML.Attribute.NOSHADE);
			Object value = eAttr.getAttribute(MHTML.Attribute.SIZE);
			if (value != null && (value instanceof String))
				size = Integer.parseInt((String) value);
			value = attr.getAttribute(MCSS.Attribute.WIDTH);
			if (value != null && (value instanceof MCSS.LengthValue)) {
				widthValue = (MCSS.LengthValue) value;
			}
			topMargin = getLength(MCSS.Attribute.MARGIN_TOP, attr);
			bottomMargin = getLength(MCSS.Attribute.MARGIN_BOTTOM, attr);
			leftMargin = getLength(MCSS.Attribute.MARGIN_LEFT, attr);
			rightMargin = getLength(MCSS.Attribute.MARGIN_RIGHT, attr);
		} else {
