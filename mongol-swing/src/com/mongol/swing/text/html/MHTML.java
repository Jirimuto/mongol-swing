...
public class MHTML{
	...
	public static class Tag {
		...
		static final Tag allTags[] = { A, ADDRESS, APPLET, AREA, B, BASE,
				...
				FRAMESET, H1, H2, H3, H4, H5, H6, HEAD, HR, HTML, I, IMG,
				INPUT, ISINDEX, KBD, LI, LINK, MAP, MENU, META, NOBR, NOFRAMES,
				OBJECT, OL, OPTION, P, PARAM, PRE, SAMP, SCRIPT, SELECT, SMALL,
				SPAN, STRIKE, S, STRONG, STYLE, SUB, SUP, TABLE, TD, TEXTAREA,
	...
	public static final class Attribute {
		...
		static final Attribute allAttributes[] = { FACE, COMMENT, SIZE, COLOR,
				...
				ROWSPAN, COLSPAN, PROMPT, HTTPEQUIV, CONTENT, LANGUAGE,
				VERSION, N, FRAMEBORDER, MARGINWIDTH, MARGINHEIGHT, SCROLLING,
	...
	static {
		...
		StyleContext.registerStaticAttributeKey(MHTML.NULL_ATTRIBUTE_VALUE);
