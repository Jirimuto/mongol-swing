...
/**
 * Modified HiddenTagView
 * 
 * @author jrmt@Almas
 */
class MHiddenTagView extends MEditableView implements DocumentListener {

	MHiddenTagView(Element e) {
		super(e);
		yAlign = 1;
	}
	...
	void updateYAlign(Font font) {
		...
		FontMetrics fm = (c != null) ? c.getFontMetrics(font) : Toolkit
	...
	void _updateModelFromText() {
		...
		if ((name instanceof MHTML.UnknownTag)
	...
	boolean isEndTag() {
		...
		if (as != null) {
			Object end = as.getAttribute(MHTML.Attribute.ENDTAG);
