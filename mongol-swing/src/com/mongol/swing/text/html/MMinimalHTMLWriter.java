...
/**
 * Modified MinimalHTMLWriter 
 *
 * @author jrmt@Almas
 */

public class MMinimalHTMLWriter extends AbstractWriter {
    ...
    private static final MCSS css = new MCSS();
     ...
     *
     */
    public MMinimalHTMLWriter(Writer w, StyledDocument doc) {
	super(w, doc);
    }
     ...
     *
     */
    public MMinimalHTMLWriter(Writer w, StyledDocument doc, int pos, int len) {
	super(w, doc, pos, len);
    }
