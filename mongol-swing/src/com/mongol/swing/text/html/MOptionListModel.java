...
class MOptionListModel extends DefaultListModel implements ListSelectionModel, Serializable {
    ...
    */
	...
	MOptionListModel clone = (MOptionListModel)super.clone();
